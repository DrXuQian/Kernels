...
template void causal_conv1d_fwd_cuda<__half, float>(ConvParamsBase &params, cudaStream_t stream);
template void causal_conv1d_fwd_cuda<__nv_bfloat16, float>(ConvParamsBase &params, cudaStream_t stream);
template void causal_conv1d_fwd_cuda<float, __half>(ConvParamsBase &params, cudaStream_t stream);
template void causal_conv1d_fwd_cuda<__half, __half>(ConvParamsBase &params, cudaStream_t stream);
template void causal_conv1d_fwd_cuda<__nv_bfloat16, __half>(ConvParamsBase &params, cudaStream_t stream);
template void causal_conv1d_fwd_cuda<float, __nv_bfloat16>(ConvParamsBase &params, cudaStream_t stream);
template void causal_conv1d_fwd_cuda<__half, __nv_bfloat16>(ConvParamsBase &params, cudaStream_t stream);
...
template void causal_conv1d_channellast_fwd_cuda<__nv_bfloat16, __half>(ConvParamsBase &params, cudaStream_t stream);
template void causal_conv1d_channellast_fwd_cuda<float, __nv_bfloat16>(ConvParamsBase &params, cudaStream_t stream);
template void causal_conv1d_channellast_fwd_cuda<__half, __nv_bfloat16>(ConvParamsBase &params, cudaStream_t stream);
