...
```bash
moe_ffn/w4a16/vllm/marlin/bench_marlin_moe 1 64 8 2048 5632
moe_ffn/w4a16/vllm/auxiliary/bench_topk_gating 1 64 8
moe_ffn/w4a16/vllm/auxiliary/bench_moe_align 1 64 8 16
moe_ffn/w4a16/vllm/auxiliary/bench_silu_and_mul 1 8 5632
moe_ffn/w4a16/vllm/auxiliary/bench_moe_sum 1 8 5632
```
...
```bash
cmake -S moe_ffn/w4a16/trtllm/moe_w4a16_standalone \
  -B moe_ffn/w4a16/trtllm/moe_w4a16_standalone/build_cmake_release \
  -DCMAKE_CUDA_ARCHITECTURES=90 \
  -DCUTLASS_DIR=$PWD/third_party/cutlass \
  -DCMAKE_BUILD_TYPE=Release
cmake --build moe_ffn/w4a16/trtllm/moe_w4a16_standalone/build_cmake_release \
...
```bash
moe_ffn/w4a16/trtllm/auxiliary/bench_custom_moe_routing 1 64 8 fp16
moe_ffn/w4a16/trtllm/auxiliary/bench_expert_map 1 64 8 auto
moe_ffn/w4a16/trtllm/auxiliary/bench_expert_map 3823 64 8 auto
```
