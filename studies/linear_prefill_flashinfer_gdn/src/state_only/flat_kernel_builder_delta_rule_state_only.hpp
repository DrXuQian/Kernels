...
#include "state_only/flat_collective_tma_warpspecialized_delta_rule_state_only.hpp"
...
struct FlatBuilderDeltaRuleStateOnly;
...
struct FlatBuilderDeltaRuleStateOnly<Element, ElementAccumulatorQK, ElementAccumulatorPV, TileShape, LayoutQ,
                            LayoutK, LayoutV, LayoutO,
                            cutlass::gemm::KernelTmaWarpSpecializedCooperative, Options> {
  using CollectiveMainloop = flat::collective::FlatMainloopTmaWarpSpecializedDeltaRuleStateOnly<
