...
#include "zero_v/flat_collective_tma_warpspecialized_delta_rule_zero_v.hpp"
...
struct FlatBuilderDeltaRuleZeroV;
...
struct FlatBuilderDeltaRuleZeroV<Element, ElementAccumulatorQK, ElementAccumulatorPV, TileShape, LayoutQ,
                            LayoutK, LayoutV, LayoutO,
                            cutlass::gemm::KernelTmaWarpSpecializedCooperative, Options> {
  using CollectiveMainloop = flat::collective::FlatMainloopTmaWarpSpecializedDeltaRuleZeroV<
