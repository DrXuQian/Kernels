...
```
cmake -S general/w4a16_gemm/machete_standalone \
  -B general/w4a16_gemm/machete_standalone/build_cmake_release \
  -DGPU_ARCH=sm_90a \
  -DCUTLASS_DIR=$PWD/third_party/cutlass \
  -DCMAKE_BUILD_TYPE=Release

cmake --build general/w4a16_gemm/machete_standalone/build_cmake_release \
...
```
general/w4a16_gemm/machete_standalone/tools/search_cutlass55_tactics.sh \
  --bin general/w4a16_gemm/machete_standalone/build_cmake_release/test_machete_gemm \
  --out-cache general/w4a16_gemm/machete_standalone/cutlass55_tactics_h800.cache \
  --out-md general/w4a16_gemm/machete_standalone/CUTLASS55_TACTICS_H800.md \
  --warmup 100 --iters 1000
```
...
```
general/w4a16_gemm/machete_standalone/build_cmake_release/test_machete_gemm --list_schedules
```
...
```
general/w4a16_gemm/machete_standalone/tools/run_all_schedules.sh \
  --bin general/w4a16_gemm/machete_standalone/build_cmake_release/test_machete_gemm \
...
```
general/w4a16_gemm/cutlass55_standalone/build_cmake_release/cutlass55_fp16_gemm \
