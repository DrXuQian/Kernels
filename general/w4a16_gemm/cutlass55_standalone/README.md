...
```
cmake -S general/w4a16_gemm/cutlass55_standalone \
  -B general/w4a16_gemm/cutlass55_standalone/build_cmake_release \
  -DGPU_ARCH=sm_90a \
  -DCUTLASS_DIR=$PWD/third_party/cutlass \
  -DCMAKE_BUILD_TYPE=Release

cmake --build general/w4a16_gemm/cutlass55_standalone/build_cmake_release \
...
nvcc -O3 -std=c++17 -arch=sm_90a --expt-relaxed-constexpr \
  ...
  -DCUTLASS_USE_FP16=1 \
  -Igeneral/w4a16_gemm/cutlass55_standalone \
  -I$CUTLASS_DIR/include \
  -I$CUTLASS_DIR/tools/util/include \
  -I$CUTLASS_DIR/examples/common \
  -I$CUTLASS_DIR/examples/55_hopper_mixed_dtype_gemm \
  general/w4a16_gemm/cutlass55_standalone/cutlass55_gemm.cu \
