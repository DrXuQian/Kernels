...
int main(int argc, char** argv) {
  ...
  sweep_q3(bd, b2p);  sweep_q5(bd, b2p);  sweep_q6_wn32(bd, b2p);  sweep_q6_wn64(bd, b2p);
  sweep_i2_wn32(bd, b1p);  sweep_i2_wn64(bd, b1p);  sweep_i4_wn32(bd, b1p);  sweep_i4_wn64(bd, b1p);
