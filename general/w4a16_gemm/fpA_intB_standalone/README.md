...
```
cmake -S general/w4a16_gemm/fpA_intB_standalone \
  -B general/w4a16_gemm/fpA_intB_standalone/build_cmake_release \
  -DGPU_ARCH=sm_90a \
  -DCUTLASS_DIR=$PWD/third_party/cutlass \
  -DCMAKE_BUILD_TYPE=Release
cmake --build general/w4a16_gemm/fpA_intB_standalone/build_cmake_release \
...
```
general/w4a16_gemm/fpA_intB_standalone/build_cmake_release/test_fpA_intB_gemm --list_configs
```
...
```
general/w4a16_gemm/fpA_intB_standalone/tools/run_all_configs.sh \
  --bin general/w4a16_gemm/fpA_intB_standalone/build_cmake_release/test_fpA_intB_gemm \
