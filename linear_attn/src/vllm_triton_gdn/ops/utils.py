...
# For AMD GPUs, the triton backend is 'hip', while the torch backend can still
# be 'cuda'. This standalone copy keeps the same distinction without depending
# on vLLM's platform abstraction.
