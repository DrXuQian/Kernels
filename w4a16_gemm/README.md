...
|---------------|-------------------|-------------|------------------|-------------------|--------------------|
| 3823×12288×3072 | **681** | 1148 | 465 | 839 | 0.68x |
| 3823×8192×3072 | **438** | 763 | 309 | 549 | 0.71x |
| 3823×3072×8192 | **419** | 758 | 323 | 555 | 0.77x |
| 3823×16384×3072 | **936** | 1604 | 620 | 1135 | 0.66x |
...
|---------------|-------------------|-------------|------------------|-------------------|--------------------|
| 1×12288×3072 | **9.7** | 15.0 | 48.6 | 38.4 | **5.01x** |
| 1×8192×3072 | **7.7** | 12.5 | 36.0 | 35.3 | **4.68x** |
| 1×3072×8192 | **8.9** | 15.9 | 39.9 | 79.5 | **4.48x** |
| 1×16384×3072 | **12.7** | 17.7 | 60.9 | 65.6 | **4.80x** |
...
- **fpAIntB (TRT-LLM) 全场景最优 W4A16 kernel**
  - Decode (M=1): CUDA core GEMV 比 Marlin 快 35-45%，比 cuBLAS BF16 快 **4.5-5.0x**
  - Prefill (M=3823): SM90 WGMMA 比 Marlin 快 40-67%，比 CUTLASS ex55 快 18-25%
